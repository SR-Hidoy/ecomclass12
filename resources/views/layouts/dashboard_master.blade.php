...
<div class="sl-mainpanel">
      <footer class="sl-footer">
        <div class="footer-left">
          <div class="mg-b-2">Copyright &copy; {{Carbon\Carbon::now()->format('Y')}} . <a href="https://hidoy.idbdev.com/">Shaied Rana Hidoy</a>. All Rights Reserved.</div>
          <div>Made by <a href="https://hidoy.idbdev.com/">Shaied Rana Hidoy</a>.</div>
        </div>
        <div class="footer-right d-flex align-items-center">
          <span class="tx-uppercase mg-r-10">Share:</span>
          <a target="_blank" class="pd-x-5" href="https://www.facebook.com/RHShaied/"><i class="fa fa-facebook tx-20"></i></a>
          <a target="_blank" class="pd-x-5" href="https://www.linkedin.com/in/shaied-rana-hidoy/"><i class="fa fa-linkedin tx-20"></i></a>
        </div>
      </footer>
    </div><!-- sl-mainpanel -->
    <!-- ########## END: MAIN PANEL ########## -->
